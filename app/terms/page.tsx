...
export const metadata: Metadata = {
  ...
  description:
    "Read SEU CampusMate's terms of service and usage guidelines. Understand your rights and responsibilities when using our platform.",
  keywords: [
    "terms of service",
    "terms",
    "legal",
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600">
              By accessing and using CampusMate, you accept and agree to be
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-gray-600 space-y-1">
                  ...
                  <li>
                    • Violating university policies or academic integrity
                    guidelines
                  </li>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">
              CampusMate provides tools to help you track and calculate academic
              metrics. However:
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• You are responsible for entering accurate data</li>
              <li>
                • Calculations are estimates and may not reflect official
                university records
              </li>
              <li>
                • Always verify important academic information with official
                university sources
              </li>
              <li>
                • We are not responsible for decisions made based on app
                calculations
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">
              The CampusMate platform, including its design, functionality, and
              content, is owned by the development team and Southeast
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600">
              ...
              modify, suspend, or discontinue any part of the service with or
              without notice. We are not liable for any inconvenience or loss
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600">
              ...
              By using CampusMate, you consent to our data practices as
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600">
              CampusMate is provided as is without warranties of any kind. We
              are not liable for any direct, indirect, incidental, or
              consequential damages arising from your use of the platform. This
              includes but is not limited to academic decisions made based on
              app calculations or any data loss.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mt-4">
              ...
              may delete your account data in accordance with our data retention
              policies.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600">
              ...
              Continued use of CampusMate after changes constitutes acceptance
              of the new terms.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">
                <strong>Email:</strong> legal@campusmate.seu.edu
                <br />
                <strong>Address:</strong> Southeast University, Dhaka,
                Bangladesh
                <br />
